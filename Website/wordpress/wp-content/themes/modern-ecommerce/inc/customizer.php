...
function modern_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_typo_heading', array(
		'label'       => esc_html__( 'Typography Setting', 'modern-ecommerce' ),
	...
	$wp_customize->add_setting('modern_ecommerce_logo_tagline_text',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			$wp_customize,
			'modern_ecommerce_logo_tagline_text',
			array(
	...
	$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_scroll_heading', array(
		'label'       => esc_html__( 'Scroll Top Setting', 'modern-ecommerce' ),
		'section'     => 'modern_ecommerce_theme_settings',
	...
	$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_shoppage_heading', array(
		'label'       => esc_html__( 'Shop Page Setting', 'modern-ecommerce' ),
		'section'     => 'modern_ecommerce_theme_settings',
		'settings'    => 'modern_ecommerce_section_shoppage_heading',
	) ) );

	$wp_customize->add_setting(
		'modern_ecommerce_shop_page_sidebar',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_setting(
		'modern_ecommerce_wocommerce_single_page_sidebar',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_post_heading', array(
		'label'       => esc_html__( 'Page Structure', 'modern-ecommerce' ),
	...
	$wp_customize->add_control(
		new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_layout',
				'label'           => __( 'Show Fullwidth', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
	...
	$wp_customize->add_setting(
		'modern_ecommerce_single_post_sidebar',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_layout',
				'label'           => __( 'Show Single Post Fullwidth', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
    ...
    $wp_customize->add_setting( 'modern_ecommerce_section_contact_heading', array(
		...
		$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_contact_heading', array(
			'label'       => esc_html__( 'Contact Setting', 'modern-ecommerce' ),		
	...
	$wp_customize->add_setting( 'modern_ecommerce_section_slide_heading', array(
		...
		$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_slide_heading', array(
			'label'       => esc_html__( 'Slider Setting', 'modern-ecommerce' ),
	...
	$wp_customize->add_setting( 'modern_ecommerce_section_footer_heading', array(
		...
		$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_footer_heading', array(
			'label'       => esc_html__( 'Footer Setting', 'modern-ecommerce' ),		
