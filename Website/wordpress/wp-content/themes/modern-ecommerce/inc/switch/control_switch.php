 ...
 * Control - Switch.
 *
 * @package Modern Ecommerce Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Modern_Ecommerce_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'modern-ecommerce-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'modern-ecommerce-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
