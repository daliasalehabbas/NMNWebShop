<?php
	...
	if( get_option( 'modern_ecommerce_sticky_header',false) != 'on') {
	...
	if( get_option( 'modern_ecommerce_sticky_header',true) != 'off') {

		$modern_ecommerce_custom_style .='.menu_header.fixed{';

			$modern_ecommerce_custom_style .='position: fixed;';
