...
?>
	...
	<?php if( get_option('modern_ecommerce_theme_loader','') != 'off'){ ?>
		<div class="preloader">
			<div class="load">
			  <hr/><hr/><hr/><hr/>
			</div>
							...
							<div class="col-lg-2 col-md-6 col-sm-6 col-6 align-self-center">
								<div class="logo text-center text-md-left text-sm-left py-3 py-md-0">
						            ...
						            <?php endif; ?>
					              	...
					              	<?php if( get_option('modern_ecommerce_logo_title',true) != 'off' ){ ?>
						            ...
						            <?php }?>
						                ...
						                ?>
						                <?php if( get_option('modern_ecommerce_logo_tagline_text',false) != 'off' ){ ?>
